        ...
        <div class="container-wide">    
			...
			<div id="get-count" >
				<table class="table table-blue table-bordered table-striped">
           			<thead><tr>
					<th style="background-color:#44484a"></th>
					<th style="background-color:#44484a">Gate 1</th>
					<th style="background-color:#44484a">Gate 2</th>
					<th style="background-color:#44484a">Gate 3</th>
				</tr></thead>
				<tr><td>How many vehicles checked</td>
				    <td>12</td>
				    <td>16</td>
				    <td>10</td>
				</tr>
				<tr><td>Average time of processing</td>
				    <td>3 min 15 sec</td>
				    <td>2 min 40 sec</td>
				    <td>4 min 1 sec</td>
				</tr>
				<tr><td>How many vehicles delayed</td>
				    <td>3</td>
				    <td>1</td>
				    <td>5</td>
				</tr>
            ...
            <div>
			    ...
			    <li class="nav-item">
                                <span class="nav-link"><strong>Duration of Stay</strong>
                                    <span class="float-right" id="date_modal">1 min 30 sec</span>
                                </span>
                            </li>
			    <li class="nav-item">
			...
			<table id="RecordsTable1" class="table table-blue table-bordered table-striped">
           		<thead><tr>
				<th style="background-color:#44484a">Gate</th>
				<th style="background-color:#44484a">Entry Device</th>
				<th style="background-color:#44484a">Camera</th> 
		   		<th style="background-color:#44484a">Plate Number</th>
		   		<th style="background-color:#44484a">Time Arrived</th>
				<th style="background-color:#44484a">Time Departed</th>		   		
		   		<th style="background-color:#44484a">Duration of Stay</th> 
		   		<th style="background-color:#44484a">ANPR Details</th> 
