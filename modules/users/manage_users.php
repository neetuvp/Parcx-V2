...
<script>
            ...
            submitHandler: function ()
            {
                ...
                $.post("../../modules/ajax/users.php", jsondata, function (result) {
                    ...
                    if (result == "Successfull"){
                       ...
                       // $("#message-modal-body").html("User Created Successfully")
                    }
                    else if (result.includes("Auto"))
                    {
                        ...
                        alertMessage(result);
                        //$("#message-modal").modal("show");
                        //$("#message-modal-body").html(result);
                        //alertMessage(result);
                        //location.reload();
                    } else
	...
	data["user_role_id"]="<?php echo $_SESSION["userRollId"]; ?>";
        var jsondata = JSON.stringify(data);
        $.post("../../modules/ajax/users.php", jsondata, function (result) {
    ...
    function showMessage(msg,type)
    {
        ...
        if(type==1){
            $("#messagebox").html("<i class='fas fa-check ml-2'></i>"+msg);
            $("#messagebox").addClass("alert-light");
